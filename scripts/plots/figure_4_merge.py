"""
Merges figure_4's 5 standalone panel PDFs (Fig_4a.pdf ... Fig_4e.pdf, from figure_4_plot.py) into
one master PDF, each panel placed at its own (x, y) from output/plots/figure_4/panel_layout.csv.
...
delta_x/delta_y size (see figure_4_plot.py's save_panel()), so placement is a pure translation, no
scaling - content stays true vector (no rasterization) via pypdf's page-merging. Same convention
as figure_3_merge.py.
